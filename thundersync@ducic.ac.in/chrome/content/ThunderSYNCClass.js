...
var ThunderSYNCClass = {
	...
	GetAbDirectory: function() {	
		var dirName = ThunderSYNCPreferences.addressBook;	
		try	{	
		...
		if ( directory != null && ThunderSYNCPreferences.clearOnStart == true )	{		
			var abManager = Components.classes["@mozilla.org/abmanager;1"].getService(Components.interfaces.nsIAbManager);
			alert(directory.URI);
